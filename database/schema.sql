...
-- The password_hash values below are generated by PHP's
-- password_hash('password', PASSWORD_DEFAULT).
-- After importing, visit /smart-transaction/database/setup.php
-- to generate proper hashes for your server environment.
-- ------------------------------------------------------------
INSERT INTO users (name, email, phone, password_hash, role) VALUES
('Admin Owner', 'admin@smarttransaction.com', '012-3456789', 'password', 'admin'),
('Co-Admin', 'coadmin@smarttransaction.com', '012-3456790', 'password', 'admin'),
('Staff Member', 'staff@smarttransaction.com', '012-3456791', 'password', 'staff');
-- All above users have password: password
-- Run setup.php after importing to hash passwords properly.
