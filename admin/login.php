<?php
/**
 * Admin Login Page — Smart Transaction
 * 
...
// If already logged in as admin/staff, redirect
...
$pageTitle = 'Admin Login — Smart Transaction';
?>
<!DOCTYPE html>
...
<div class="auth-page">
    ...
    <div class="auth-left">
        ...
        <p class="auth-tagline">Staff & Admin Portal</p>
    ...
    <div class="auth-right">
        <div class="auth-form-container">
            ...
            <form method="POST" action="">
                <div class="form-group">
                    ...
                    <input type="email" id="email" name="email" class="form-input" 
                           placeholder="staff@smarttransaction.com" required
            ...
            <p class="mt-3 text-center" style="font-size: 0.9rem; color: var(--color-text-muted);">
                <a href="/smart-transaction/auth/login.php">Customer Login</a>
            </p>
        </div>
    </div>
</div>
